...
const InvestorAnalytics = ({ stats, investments }) => {
    ...
    return (
        <div className="animate-fade">
            <div style={{ display: 'grid', gridTemplateColumns: windowWidth > 1024 ? 'repeat(4, 1fr)' : 'repeat(2, minmax(0, 1fr))', gap: windowWidth <= 480 ? '0.75rem' : '1.5rem', marginBottom: '2.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: windowWidth > 768 ? 'minmax(0, 1.5fr) minmax(0, 1fr)' : 'minmax(0, 1fr)', gap: windowWidth <= 480 ? '1rem' : '1.5rem' }}>
